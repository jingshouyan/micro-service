...
import io.jing.util.jdbc.core.util.db.OrderBy;
...
public abstract class AbstractSqlGenerator<T> implements SqlGenerator<T> {
    ...
    @Override
    public SqlPrepared query(List<Compare> compares) {
    ...
    @Override
    public SqlPrepared count(List<Compare> compares) {
        SqlPrepared sqlPrepared = new SqlPrepared();
    ...
    @Override
    public SqlPrepared update(T bean, List<Compare> compares) {
        SqlPrepared sqlPrepared = new SqlPrepared();
    ...
    @Override
    public SqlPrepared delete(List<Compare> compares) {
        SqlPrepared sqlPrepared = new SqlPrepared();
    ...
    protected SqlPrepared where(List<Compare> compares){
        SqlPrepared sqlPrepared = new SqlPrepared();
        StringBuilder sql = new StringBuilder();
    ...
    protected String tableName() {
        return Bean4DbUtil.getBeanTable(clazz).getTableName();
    }

    protected String tableComment(){
        return Bean4DbUtil.getBeanTable(clazz).getComment();
    }

    protected String columnName(String fieldName) {
        return q()+Bean4DbUtil.getColumnName(clazz, fieldName)+q();
    }
