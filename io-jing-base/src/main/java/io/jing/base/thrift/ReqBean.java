...
public class ReqBean implements org.apache.thrift.TBase<ReqBean, ReqBean._Fields>, java.io.Serializable, Cloneable, Comparable<ReqBean> {
  ...
  private static final org.apache.thrift.protocol.TField ONE_WAY_FIELD_DESC = new org.apache.thrift.protocol.TField("oneWay", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  private static final int __ONEWAY_ISSET_ID = 0;
  ...
  static {
    ...
    tmpMap.put(_Fields.PARAM, new org.apache.thrift.meta_data.FieldMetaData("param", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.ONE_WAY, new org.apache.thrift.meta_data.FieldMetaData("oneWay", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public ReqBean setMethod(String method) {
    this.method = method;
    return this;
  }
  ...
  public ReqBean setParam(String param) {
    this.param = param;
    return this;
  }
  ...
  public ReqBean setOneWay(boolean oneWay) {
    this.oneWay = oneWay;
    setOneWayIsSet(true);
    return this;
  }
  ...
  public void unsetOneWay() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __ONEWAY_ISSET_ID);
  }

  /** Returns true if field oneWay is set (has been assigned a value) and false otherwise */
  public boolean isSetOneWay() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __ONEWAY_ISSET_ID);
  }

  public void setOneWayIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __ONEWAY_ISSET_ID, value);
  }
  ...
  public boolean equals(ReqBean that) {
    ...
    boolean this_present_oneWay = true;
    boolean that_present_oneWay = true;
    if (this_present_oneWay || that_present_oneWay) {
      if (!(this_present_oneWay && that_present_oneWay))
        return false;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((oneWay) ? 131071 : 524287);
  ...
  public int compareTo(ReqBean other) {
    ...
    if (isSetOneWay()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.oneWay, other.oneWay);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ReqBean(");
    boolean first = true;
  ...
  private static class ReqBeanStandardScheme extends org.apache.thrift.scheme.StandardScheme<ReqBean> {
        ...
        switch (schemeField.id) {
          ...
          case 3: // ONE_WAY
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.oneWay = iprot.readBool();
              struct.setOneWayIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReqBean struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(ONE_WAY_FIELD_DESC);
      oprot.writeBool(struct.oneWay);
      oprot.writeFieldEnd();
